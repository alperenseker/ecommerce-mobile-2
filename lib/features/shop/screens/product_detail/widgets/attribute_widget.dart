/// Tek bir özniteliğin (ör. "Renk") seçilebilir değerleri.
///
/// [TProductAttributes] ile aynı eski varyasyon modeline bakar ve referansta
/// da hiçbir yerden çağrılmaz; KURALLAR §4 gereği taşındı.
library;
...
class AttributeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Hangi değerler fiilen stokta: boş ya da stoksuz olanlar seçilemez.
