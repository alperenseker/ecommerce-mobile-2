/// Profil ekranındaki "etiket → değer" satırı.
///
/// Sağdaki ikon satırın düzenlenebilir olup olmadığını söyler: düzenlenebilir
/// alanlarda ok, 1C'den gelen kilitli alanlarda kilit (çağıran veriyor).
library;
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(child: Icon(icon, size: 18, color: TColors.darkGrey)),
          ],
        ),
      ),
    );
