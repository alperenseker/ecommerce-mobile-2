/// `flutter_local_notifications` sarmalayıcısı — cihaz üstü bildirimler.
library;
...
/// Local-only notification service.
///
/// TODO: Remote push notifications (FCM) were removed along with Firebase.
/// If the backend adds a push provider, wire token registration and
/// incoming-message handling back in here.
