/// Daire görsel + altında metin (yatay kategori şeridinde kullanılır).
library;
...
class TVerticalImageAndText extends StatelessWidget {
  ...
  const TVerticalImageAndText({
    ...
    this.textColor = TColors.textPrimary,
  });
        ...
        child: Column(
          children: [
            TCircularImage(
              ...
              backgroundColor: backgroundColor ?? TColors.lightContainer,
