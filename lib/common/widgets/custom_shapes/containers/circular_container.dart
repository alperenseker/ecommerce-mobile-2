/// Daire (ya da çok yuvarlak köşeli) kap.
///
/// Renk çemberi çipinden avatar altlığına kadar her yerde kullanılıyor;
/// varsayılan çerçeve rengi TASARIM.md §2'deki `borderPrimary`.
library;
